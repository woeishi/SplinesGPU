...
// VERTEXSHADER-----------------------------------------------------------------
float4 BezierSplinePWGPU(float4 PosO: POSITION, float3 NormO: NORMAL, float4 PosCd : TEXCOORD1, out float3 Tang, out float3 BiTang)
{
	...
	pota curve = BezierSplinePW(p1,float4(t1.xyz,0),p2,float4(t2.xyz,0),PosCd.x*cSize);	
