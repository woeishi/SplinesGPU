...
//@tags: curve, spline, bezier, quadratic bezier
// PARAMETERS-------------------------------------------------------------------
int Size;
...
// VERTEXSHADER-----------------------------------------------------------------
float4 QuadraticBezierSplineGPU(float4 PosO: POSITION, float3 NormO: NORMAL, float4 PosCd: TEXCOORD1, out float3 Tang, out float3 BiTang)
{
